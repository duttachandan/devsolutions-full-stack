                        ...
                        <div className="text-color-brand flex-embed is-visible w-embed">
                            <Link className="w-37.25" href="/">
                                <svg
                                    ...
                                    width="149" height="48" viewBox="0 0 149 48" fill="none" style={{ color: 'white' }}>
                                ...
                                {/* <Image width={189} height={48} src={Logo} alt="Brand Logo" /> */}
                            </Link>
                        </div>
                    </div>
                    <div className='flex items-center ms-auto'>
                        <ul className="flex list-none ms-auto gap-3 items-center">
                            ...
                            <li className="h-12.5 w-12.5">
                                ...
                                >
                                    <IoIosMenu size={34} style={{ strokeWidth: '5' }} />
                                </span>
                            </li>
                        </ul>
                    </div>
